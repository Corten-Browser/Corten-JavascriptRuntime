...
class OrchestratorMonitor:
    ...
    def __init__(self):
        self.metrics_file = Path("orchestration/monitoring/metrics.json")
        self.alerts_file = Path("orchestration/monitoring/alerts.json")
    ...
    def collect_metrics(self) -> dict:
        ...
        # Gate status
        try:
            log_file = Path("orchestration/automated_gates/execution_log.json")
            if log_file.exists():
