...
```bash
# View queue status
python orchestration/task_queue/task_runner.py

# Get current task details
python orchestration/task_queue/task_runner.py --current

# Mark task complete (after implementation + tests)
python orchestration/task_queue/task_runner.py --complete {current['id'] if current else 'TASK-ID'}
